...
async function generateCounterCard(sourceArticle) {
  const system = `You are a counter-argument generator for a news app. Given a news story, write the strongest good-faith OPPOSING perspective to the obvious reading of it. Return ONLY valid JSON, not markdown. Return: { "title": "...", "body": "...", "question": "..." }`;
