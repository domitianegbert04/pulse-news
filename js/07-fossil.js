...
async function revealFossil(articleId, e) {
  ...
  container.innerHTML = `<div class="thread"><div class="bubble ai"><div class="bubble-avatar">⏳</div><div class="bubble-content"><div class="bubble-name">Pulse AI · Looking back</div><div class="bubble-text">Looking back...</div></div></div></div>`;
